 ...
 */
class UNREALCOMPANION_API FUnrealCompanionBlueprintCommands
{
public:
    FUnrealCompanionBlueprintCommands();
...
private:
    ...
    TSharedPtr<FJsonObject> HandleListParentClasses(const TSharedPtr<FJsonObject>& Params);
    
    // =========================================================================
    // BATCH OPERATIONS
    // =========================================================================
    TSharedPtr<FJsonObject> HandleVariableBatch(const TSharedPtr<FJsonObject>& Params);
    TSharedPtr<FJsonObject> HandleComponentBatch(const TSharedPtr<FJsonObject>& Params);
    TSharedPtr<FJsonObject> HandleFunctionBatch(const TSharedPtr<FJsonObject>& Params);
