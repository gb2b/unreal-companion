...
TSharedPtr<FJsonObject> FUnrealCompanionUMGCommands::HandleCreateUMGWidgetBlueprint(const TSharedPtr<FJsonObject>& Params)
{
	...
	{
		return FUnrealCompanionCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Widget Blueprint '%s' already exists"), *BlueprintName));
	}
...
TSharedPtr<FJsonObject> FUnrealCompanionUMGCommands::HandleAddTextBlockToWidget(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!WidgetBlueprint)
	{
		return FUnrealCompanionCommonUtils::CreateErrorResponse(FString::Printf(TEXT("Widget Blueprint '%s' not found"), *BlueprintName));
	}
	...
	if (!TextBlock)
	{
		return FUnrealCompanionCommonUtils::CreateErrorResponse(TEXT("Failed to create Text Block widget"));
	}
	...
	if (!RootCanvas)
	{
		return FUnrealCompanionCommonUtils::CreateErrorResponse(TEXT("Root Canvas Panel not found"));
	}
...
TSharedPtr<FJsonObject> FUnrealCompanionUMGCommands::HandleAddWidgetToViewport(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (!WidgetClass)
	{
		return FUnrealCompanionCommonUtils::CreateErrorResponse(TEXT("Failed to get widget class"));
	}
...
TSharedPtr<FJsonObject> FUnrealCompanionUMGCommands::HandleSetTextBlockBinding(const TSharedPtr<FJsonObject>& Params)
{
	...
	if (FuncGraph)
	{
		...
		FBlueprintEditorUtils::AddFunctionGraph(WidgetBlueprint, FuncGraph, false, SignatureClass);
