...
- Call mark_section_complete ONLY after ALL of these conditions are met:
  1. You have called update_document with real, substantive content (not placeholder text).
...
- NEVER call mark_section_complete without a preceding update_document in the same or recent turn.
